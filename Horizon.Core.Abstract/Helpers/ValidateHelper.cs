...
namespace Horizon.Core.Abstract.Helpers
{
    ...
    public static class ValidateHelper
    {
        ...
        public static bool BetweenPeriod(this string[] periodList, out string liePeriod)
        {
            if (periodList != null && periodList.Length > 0)
            {
                ...
                foreach (string str in periodList)
                {
                    ...
                    DateTime time = str.Substring(0, index).StringToDateTime();
                    DateTime time2 = str.Substring(index + 1).StringToDateTime();
                    if (time < time2)
                    {
        ...
        {
            return (!string.IsNullOrWhiteSpace(s) && _emailregex.IsMatch(s));
        }
        ...
        /// </summary>
        /// <returns> </returns>
        public static bool IsImgFileName(this string fileName, string[] fileExtensions = null)
        {
            ...
            if (fileExtensions != null)
                return fileExtensions.Any(m => m == str);
        ...
        {
            return (!string.IsNullOrWhiteSpace(s) && _phoneregex.IsMatch(s));
        }
        ...
        {
            return (string.IsNullOrWhiteSpace(s) || _zipcoderegex.IsMatch(s));
        }
