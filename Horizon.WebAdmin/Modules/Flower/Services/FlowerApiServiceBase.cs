...
public class FlowerApiServiceBase
{
    private readonly HttpClient _httpClient;
    private readonly string _adminApiKey;

    protected FlowerApiServiceBase(HttpClient httpClient, IConfiguration configuration)
    {
    ...
    private void ApplyAdminKeyIfConfigured()
    {
