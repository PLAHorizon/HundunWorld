// ============================================================
// NS_CharacterPortalDissolve 粒子资源创建脚本
...
public class CreateNS_CharacterPortalDissolveAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_CharacterPortalDissolve/NS_CharacterPortalDissolve_Emitter.flax";
        var systemPath = @"Particles/NS_CharacterPortalDissolve/NS_CharacterPortalDissolve_System.flax";
