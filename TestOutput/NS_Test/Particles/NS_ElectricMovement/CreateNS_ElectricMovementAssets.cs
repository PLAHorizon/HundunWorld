...
public class CreateNS_ElectricMovementAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_ElectricMovement/NS_ElectricMovement_Emitter.flax";
        var systemPath = @"Particles/NS_ElectricMovement/NS_ElectricMovement_System.flax";
