...
public class CreateNS_WallPortalAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_WallPortal/NS_WallPortal_Emitter.flax";
        var systemPath = @"Particles/NS_WallPortal/NS_WallPortal_System.flax";
