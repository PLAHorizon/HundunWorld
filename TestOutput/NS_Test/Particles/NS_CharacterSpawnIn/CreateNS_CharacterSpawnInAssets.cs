...
public class CreateNS_CharacterSpawnInAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_CharacterSpawnIn/NS_CharacterSpawnIn_Emitter.flax";
        var systemPath = @"Particles/NS_CharacterSpawnIn/NS_CharacterSpawnIn_System.flax";
