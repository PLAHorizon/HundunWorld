...
public class CreateNS_CharacterDashAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_CharacterDash/NS_CharacterDash_Emitter.flax";
        var systemPath = @"Particles/NS_CharacterDash/NS_CharacterDash_System.flax";
