...
public class CreateNS_JumpPadAssets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_JumpPad/NS_JumpPad_Emitter.flax";
        var systemPath = @"Particles/NS_JumpPad/NS_JumpPad_System.flax";
