...
public class CreateNS_CharacterSpawnIn2Assets
{
    /// <summary>主入口：创建 ParticleEmitter + ParticleSystem + 更新 Prefab 引用。</summary>
    public static void CreateAll()
    {
        var emitterPath = @"Particles/NS_CharacterSpawnIn2/NS_CharacterSpawnIn2_Emitter.flax";
        var systemPath = @"Particles/NS_CharacterSpawnIn2/NS_CharacterSpawnIn2_System.flax";
