...
namespace Horizon.Game.Core.Handlers
{
    ...
    //                {
    //                    GameId = (int)request.Header.GameId,
    //                    ServerId = (int)request.Header.ServerId,
    //                    AreaId = (int)request.Header.ZoneId,
    //                    Ip = registerRequest.PlatformId,
    //                    PlatformId = registerRequest.PlatformId
    //                }
    //            };
