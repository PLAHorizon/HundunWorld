    ...
    public struct ParticleEffectConfig
    {
        ...
        public static ParticleEffectConfig CreateDialogDefault()
        {
            return new ParticleEffectConfig
            {
                ...
                MaxSize = 2.5f,
                TwinkleSpeed = 1.5f,
                PrimaryColor = new Color(0.8f, 0.85f, 1.0f, 0.8f),
                SecondaryColor = new Color(1.0f, 0.95f, 0.8f, 0.6f),
                MinAlpha = 0.2f,
                MaxAlpha = 0.9f,
        ...
        public static ParticleEffectConfig CreateSimplified()
        {
            return new ParticleEffectConfig
            {
                ...
                MaxSize = 2.0f,
                TwinkleSpeed = 1.0f,
                PrimaryColor = new Color(0.7f, 0.8f, 1.0f, 0.6f),
                SecondaryColor = new Color(0.9f, 0.9f, 0.9f, 0.4f),
                MinAlpha = 0.3f,
                MaxAlpha = 0.7f,
        ...
        public static ParticleEffectConfig CreateLoginBackground()
        {
            return new ParticleEffectConfig
            {
                ...
                MaxSize = 2.0f,
                TwinkleSpeed = 0.8f,
                PrimaryColor = new Color(0.6f, 0.8f, 1.0f, 0.3f),
                SecondaryColor = new Color(1.0f, 0.9f, 0.7f, 0.2f),
                MinAlpha = 0.1f,
                MaxAlpha = 0.6f,
                EnableAdvancedEffects = true,
        ...
        public static ParticleEffectConfig CreateGameUI()
        {
            return new ParticleEffectConfig
            {
                ...
                MaxSize = 1.8f,
                TwinkleSpeed = 1.2f,
                PrimaryColor = new Color(0.9f, 0.85f, 0.7f, 0.5f),
                SecondaryColor = new Color(0.7f, 0.9f, 1.0f, 0.4f),
                MinAlpha = 0.2f,
                MaxAlpha = 0.8f,
                EnableAdvancedEffects = true,
                UseGPUParticles = false,
